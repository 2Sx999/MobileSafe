...
public class SettingCenterActivity extends Activity {
	...
	private void initEvent() {
		...
		sci_incomingnumberlocation.setOnToggleChangedListener(onToggleChangedListener);
	...
	private void initData() {
		...
		//回显黑名单拦截服务是否开启
		sci_blacklistintercept.setToggle(ServiceUtil.isServiceRunning(this, "cn.porkchop.mobilesafe.service.BlackListInterceptService"));
		sci_incomingnumberlocation.setToggle(ServiceUtil.isServiceRunning(this, "cn.porkchop.mobilesafe.service.ShowIncomingNumberLocationService"));
	}
